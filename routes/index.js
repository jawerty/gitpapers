...
exports.userPosts = function(req, res) {
  ...
  request.get({url: "https://api.github.com/users/" + username
    , headers: {"User-Agent": "node.js"}}
    ...
    request.get({url: "https://api.github.com/repos/" + username + "/gitpapers-blog/contents"
      , headers: {"User-Agent": "node.js"}}
...
exports.post = function(req, res) {
  ...
  request.get({url: "https://api.github.com/users/" + _username
    , headers: {"User-Agent": "node.js"}}
    , function(err, response, body1) {
    data1 = JSON.parse(body1);
  ...
  if(works == true) {
    request.get({url: "https://api.github.com/repos/" + _username + "/gitpapers-blog/contents/" + title + ".md"
      , headers: {"User-Agent": "node.js"}}
